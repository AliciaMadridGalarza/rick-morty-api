package com.fpmislata.daw1.nomprojecte.persistance.database;
 ...
 * http://stackoverflow.com/questions/5332149/jdbc-scriptrunner-java-lang-nullpointerexception
 */
/*
 * Modified: Use logWriter in print(Object), JavaDoc comments, correct Typo.
 */
/*
 * Modified by Pantelis Sopasakis <chvng@mail.ntua.gr> to take care of DELIMITER statements.
 * This way you * can execute scripts that contain some TRIGGER creation code.
 * New version using REGEXPs! Latest * modification: Cater for a NullPointerException while parsing.
 ...
 */
/*
 * Copyright 2004 Clinton Begin Licensed under the Apache License, Version 2.0 (the "License");
